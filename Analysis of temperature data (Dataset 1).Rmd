...
# chi.bar(u) vs u
par(mar = c(4.2, 4.5, 1, 1))
chiplot(data = dat, nq = 100, qlim = c(0.5,0.992), which = 2, conf = 0.95, cicol = "seagreen", trunc = F, ylim2 = c(-1.1,1.3), spcases = T, xlab = expression(u), ylab2 = expression(hat(bar(chi))(u)), main2 = "", xlim = c(0.5,1), col = "black", lwd = 1.5)
...
add = T, lty = 5, col = "seagreen4", lwd = set.lwd) 
